...
export async function POST(req: NextRequest) {
  try {
    ...
    //    Fricción cero: SIEMPRE se crea el expediente. La señal de coherencia NO
    //    bloquea; se persiste como aviso interno (datos_incompletos) que solo ve
    //    el coordinador en el panel. (ia.coherente -> datos_incompletos en el store.)
