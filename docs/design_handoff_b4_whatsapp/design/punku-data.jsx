...
const ESTADOS = [
  { id:'recibido', es:'Recibido', qu:'Chaskisqa',
    czEs:'Recibimos tu necesidad. Ya está en PUNKU.', czQu:'Necesidadniykita chaskiykunña.' },
  { id:'revision', es:'En revisión', qu:'Qawachkan',
    czEs:'La universidad está viendo a qué facultad le corresponde.', czQu:'Universidadqa mayqin facultadtam qawachkan.' },
  { id:'derivado', es:'Derivado', qu:'Kachasqa',
    czEs:'Tu caso ya llegó al equipo que puede ayudarte.', czQu:'Caseykiqa yanapaq llamkaqkunaman chayan.' },
  { id:'atendido', es:'Atendido', qu:'Yanapasqa',
    czEs:'Hay un equipo trabajando contigo en tu comunidad.', czQu:'Huk llamkaqkuna aylluykipi llamkachkan.' },
  { id:'cerrado', es:'Cerrado', qu:'Tukusqa',
    czEs:'El caso terminó. Gracias por confiar en PUNKU.', czQu:'Caseyki tukurun. Yusulpayki.' },
];

/* ---------- Facultades UNCP (para derivar) ---------- */
const FACULTADES = [
  'Ingeniería Ambiental','Ingeniería Eléctrica','Arquitectura','Agronomía','Zootecnia',
  'Medicina Humana','Enfermería','Ciencias de la Educación','Ingeniería Civil',
  'Ingeniería de Sistemas','Antropología','Trabajo Social','Economía',
  'Otra entidad (ONG / Gob. regional)',
];

/* ---------- Expedientes ficticios (CRM) ----------
   calidad: 'rica' = el relato ciudadano aporta señal suficiente (pre-llena 60–70%)
            'pobre'= relato vago / “basura” → señal baja, nunca se rechaza, exige co-creación
   relato  = lo que el ciudadano escribió tal cual en “¿Quieres contarnos más?”
*/
const EXPEDIENTES = [
  /* ===== DEMO A · BIEN LLENADO (≈70% auto) ===== */
  { codigo:'PUNKU-2026-039', comunidad:'CC Makaka', distrito:'Kakak', cat:'infra',
    urgencia:'alta', estado:'revision', fecha:'14 jun 2026', familias:240, canal:'PUNKU',
    confianza:75, facultades:['Ingeniería Civil','Ingeniería Eléctrica','Arquitectura'],
    modalidad:'Polivalente · varias facultades',
    representante:'(reservado)', telefono:'(reservado)',
    calidad:'rica',
    aspiracion:'Un local comunal con buena luz para reunirnos y dar servicios.',
    relato:'Desde hace tiempo la luz se va a cada rato y no alcanza para todos. Somos como 240 familias. Queremos un local comunal que tenga buena electricidad, para reuniones, para la posta, para los chicos. Es lo que más necesitamos.',
    titulo:'No tenemos buena electricidad',
    resumen:'Comunidad del distrito de Kakak presenta deficiencia en la calidad y disponibilidad del servicio de electricidad, afectando a 240 familias. La necesidad demandada es la construcción de un local comunal que funcione como centro de servicios e integración social, requiriendo solución integral del abastecimiento energético. Se requiere articulación entre infraestructura eléctrica y edificación comunitaria.' },

  /* ===== DEMO B · INFO BASURA (señal baja) ===== */
  { codigo:'PUNKU-2026-041', comunidad:'CC San Roque', distrito:'Pucará', cat:'infra',
    urgencia:'media', estado:'recibido', fecha:'14 jun 2026', familias:null, canal:'PUNKU',
    confianza:31, facultades:['Trabajo Social'],
    modalidad:'Por confirmar', representante:'(reservado)', telefono:'(reservado)',
    calidad:'pobre',
    aspiracion:'',
    relato:'xyz asdfg ayuda porfa no se que poner',
    titulo:'Solicitud por precisar — falta información de la comunidad',
    resumen:'El relato ciudadano no aporta detalles suficientes para clasificar con confianza. PUNKU registró igual la solicitud para no perder el pedido, pero faltan datos clave: necesidad concreta, lugar exacto y número de familias. Antes de armar la solicitud conviene contactar a la comunidad para precisar.' },

  { codigo:'PUNKU-2026-014', comunidad:'CC Alto Mantaro', distrito:'Pariahuanca', cat:'agua',
    urgencia:'alta', estado:'recibido', fecha:'13 jun 2026', familias:120, canal:'PUNKU Emergencias',
    confianza:94, facultades:['Ingeniería Ambiental','Zootecnia'], modalidad:'Proyecto de proyección social',
    representante:'(reservado)', telefono:'(reservado)',
    aspiracion:'Que el río vuelva a estar limpio y podamos criar truchas otra vez.',
    titulo:'Posible contaminación del río afecta truchas y consumo',
    resumen:'La comunidad reporta que el agua del río presenta coloración y olor extraños; mueren truchas de criaderos familiares y temen por el agua de consumo. Solicitan evaluación de calidad del agua y orientación técnica urgente.' },
  { codigo:'PUNKU-2026-013', comunidad:'CC Sumac Pampa', distrito:'Sapallanga', cat:'agro',
    urgencia:'media', estado:'revision', fecha:'12 jun 2026', familias:48, canal:'PUNKU',
    confianza:88, facultades:['Zootecnia','Agronomía'], modalidad:'Asistencia técnica',
    representante:'(reservado)', telefono:'(reservado)',
    aspiracion:'Que nuestros animales estén sanos y podamos vender mejor.',
    titulo:'Enfermedad en el ganado ovino reduce ingresos familiares',
    resumen:'Animales presentan síntomas de enfermedad recurrente que reduce la producción. La comunidad pide una campaña veterinaria y capacitación en manejo sanitario del ganado.' },
  { codigo:'PUNKU-2026-012', comunidad:'CC Suelos Vivos', distrito:'Quilcas', cat:'agua',
    urgencia:'media', estado:'derivado', fecha:'11 jun 2026', familias:75, canal:'PUNKU',
    confianza:91, facultades:['Ingeniería Ambiental'], modalidad:'Proyecto de proyección social',
    representante:'(reservado)', telefono:'(reservado)',
    aspiracion:'Tener nuestra comunidad limpia y ordenada.',
    titulo:'Manejo de residuos sólidos en la comunidad',
    resumen:'No cuentan con manejo de residuos; solicitan acompañamiento para implementar un plan comunal de segregación y compostaje.' },
  { codigo:'PUNKU-2026-011', comunidad:'Barrio La Esperanza', distrito:'El Tambo', cat:'educ',
    urgencia:'baja', estado:'atendido', fecha:'10 jun 2026', familias:60, canal:'PUNKU',
    confianza:85, facultades:['Ciencias de la Educación'], modalidad:'Voluntariado universitario',
    representante:'(reservado)', telefono:'(reservado)',
    aspiracion:'Que nuestros niños aprendan mejor y tengan más oportunidades.',
    titulo:'Refuerzo escolar para niños de primaria',
    resumen:'Solicitan apoyo de estudiantes para reforzamiento en lectura y matemática de niños de primaria.' },
  { codigo:'PUNKU-2026-010', comunidad:'CC Tres Esquinas', distrito:'Chilca', cat:'infra',
    urgencia:'media', estado:'revision', fecha:'09 jun 2026', familias:90, canal:'PUNKU',
    confianza:79, facultades:['Ingeniería Civil'], modalidad:'Estudio técnico',
    representante:'(reservado)', telefono:'(reservado)',
    aspiracion:'Tener agua suficiente para que las chacras produzcan bien.',
    titulo:'Sistema de riego deteriorado afecta las chacras',
    resumen:'El canal de riego está deteriorado y reduce el agua para cultivos. Piden un estudio y propuesta de mejora.' },
  { codigo:'PUNKU-2026-009', comunidad:'CC Wari Marca', distrito:'Sicaya', cat:'salud',
    urgencia:'baja', estado:'cerrado', fecha:'06 jun 2026', familias:140, canal:'PUNKU',
    confianza:90, facultades:['Enfermería','Medicina Humana'], modalidad:'Campaña de salud',
    representante:'(reservado)', telefono:'(reservado)',
    aspiracion:'Que las familias estén sanas y sepan cuidarse.',
    titulo:'Campaña de salud preventiva realizada',
    resumen:'Se solicitó y ejecutó una campaña de salud preventiva para la comunidad.' },
  { codigo:'PUNKU-2026-008', comunidad:'CC Kuntur Wasi', distrito:'Pucará', cat:'cultura',
    urgencia:'baja', estado:'recibido', fecha:'05 jun 2026', familias:35, canal:'PUNKU',
    confianza:72, facultades:['Antropología','Trabajo Social'], modalidad:'Proyecto de proyección social',
    representante:'(reservado)', telefono:'(reservado)',
    aspiracion:'Que los jóvenes se queden y valoren nuestras costumbres.',
    titulo:'Jóvenes migran: rescate de identidad y oportunidades',
    resumen:'La comunidad busca actividades que arraiguen a los jóvenes y rescaten tradiciones locales.' },
];
...
const STR = {
  es:{
    ...
    track_now:'Ahora', track_back:'Hacer otra consulta',
  ...
  qu:{ /* Quechua Wanka (Waylla · Huancayo) — borrador informado, requiere validación de hablante nativo */
    ...
    track_now:'Kunan', track_back:'Huktawan maskay',
...
function catLabel(cat, lang){ return lang==='qu' ? cat.qu : cat.es; }

Object.assign(window, { CATEGORIES, PROBLEMS, DISTRITOS, ESTADOS, FACULTADES, EXPEDIENTES, STR, t, catLabel });
