...
export interface ExpedienteSeed {
  ...
  titulo: string;
  resumen: string;
  /** Relato crudo del ciudadano (se cita tal cual cuando llega con poca info). */
  relato?: string;
  /** Llegó con poca información: nunca se rechaza, pero pide co-creación. */
...
export const EXPEDIENTES: ExpedienteSeed[] = [
  ...
  { codigo: "PUNKU-2026-016", comunidad: "CC Sumaq Uywa", distrito: "Sapallanga", cat: "agro", urgencia: "baja", estado: "recibido", fecha: "14 jun 2026", familias: 0, canal: "PUNKU", confianza: 25, facultades: ["Por confirmar"], modalidad: "Por confirmar", representante: "Pedro Cama Aliaga", telefono: "987 222 333", aspiracion: "", titulo: "Pedido de agro con poca información", relato: "mis cosas en la chacra no se ayuda", resumen: "La comunidad envió un pedido de agricultura/ganadería con muy poca información. PUNKU lo registró igual: no se rechaza ningún pedido. Falta precisar el problema, a cuántas familias afecta y qué espera lograr. Conviene reconstruir el contexto con la comunidad por WhatsApp.", datos_incompletos: true },
  { codigo: "PUNKU-2026-015", comunidad: "CC Anexo Ñuñunhuayo", distrito: "Huancán", cat: "infra", urgencia: "baja", estado: "recibido", fecha: "14 jun 2026", familias: 0, canal: "PUNKU", confianza: 31, facultades: ["Por confirmar"], modalidad: "Por confirmar", representante: "Rosa Huamán Ccanto", telefono: "987 654 321", aspiracion: "", titulo: "Pedido con poca información — requiere contacto", relato: "ayuda porfa no se que poner aca pero necesitamos algo en la comunidad", resumen: "La comunidad envió un pedido con muy poca información. PUNKU lo registró igual: no se rechaza ningún pedido. Falta precisar cuál es el problema, a cuántas familias afecta y qué espera lograr la comunidad. Conviene contactarla (por WhatsApp) para co-construir la solicitud antes de formalizar.", datos_incompletos: true },
